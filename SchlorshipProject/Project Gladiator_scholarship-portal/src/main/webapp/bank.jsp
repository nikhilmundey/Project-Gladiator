...
<div class="login-page">
  <div class="form">
    ...
    <form class="login-form" action="studentbank.lti" method="post">
      <input type="text" name="accountNo" placeholder="Account Number" pattern="[0-9]{1}[0-9]{11}" required/>
      ...
      <!-- onclick="window.location.href='stdDoc.html'" -->
    </form>
  </div>
</div>
</body>
